...
class TodoDetailState extends State{
  ...
  TextEditingController decsriptionController = TextEditingController();
  ...
  Widget build(BuildContext context) {
    ...
    decsriptionController.text = todo.description;
  ...
  void updateDescription(){
    todo.description = decsriptionController.text;
  }
